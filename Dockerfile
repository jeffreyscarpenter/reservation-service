...
CMD ./wait-for-it.sh -s -t 30 ${CASSANDRA_CONTACT_HOST}:${CASSANDRA_CONTACT_PORT} -- java -Dcassandra.contactPoint=${CASSANDRA_CONTACT_HOST} -jar /app/reservation-service-0.0.1-SNAPSHOT.jar
